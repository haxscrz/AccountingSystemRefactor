          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right">
                <div className={`text-[13px] font-bold leading-snug ${darkMode ? 'text-gray-100' : 'text-on-surface'}`}>{displayName || user?.username || (user?.role === 'superadmin' ? 'Super Admin' : user?.role === 'tester' ? 'Tester' : 'Accountant')}</div>
